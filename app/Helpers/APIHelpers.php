    ...
    class APIHelpers {
       ...
       public static function distance($lat1, $lon1, $lat2, $lon2, $unit) {
          ...
          public static function send_notification($title , $body , $image , $data , $token){
            ...
            $server_key="AAAAOG-BI8o:APA91bFBC_IC84DWwrJG0pY_fkNmraaLzeT91QsQwN7dGhxNI6vARZ4YEIJltK3ZYrwAKPn1HmAAU1nNtpFNmjYXU0MNAU6bpLFs-oceeNreZJzoVmayN56Vc70Fd1KVCAPcUqibSbuU";
