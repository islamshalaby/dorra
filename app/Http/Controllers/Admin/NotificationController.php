...
class NotificationController extends AdminController{
    ...
    public function delete(Request $request){
        ...
        $users_notifications = UserNotification::where('notification_id' , $request->id)->delete();
    ...
    public function send(Request $request){
        ...
        $notificationss = APIHelpers::send_notification($notification->title , $notification->body , $notification->image , null , $fcm_tokens);    
        return redirect('admin-panel/notifications/show');
    }
