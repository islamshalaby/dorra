...
<head>
	...
	{{-- <link rel="stylesheet" href="/admin/assets/css/ck-samples.css"> --}}
...
<body>
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                   ...
                   @if(in_array(1 , Auth::user()->custom['admin_permission'])) 
                    ...
                    <li class="menu donations">
                        <a href="/admin-panel/donations/show" class="dropdown-toggle first-link">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-box"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"></path><polyline points="3.27 6.96 12 12.01 20.73 6.96"></polyline><line x1="12" y1="22.08" x2="12" y2="12"></line></svg>                                
                                <span>{{ __('messages.donations') }}
                                    @if( Auth::user()->custom['donation_count'] > 0 )
                                    <span class="unreadcount" > 
                                        <span class="insidecount" > 
                                            <?=Auth::user()->custom['donation_count']?> 
                                        </span> 
                                    </span>
                                    @endif
                                </span>
                    ...
                    <li class="menu orders">
                        <a href="/admin-panel/orders/show" class="dropdown-toggle first-link">
                            <div class="">
                    ...
                    <li class="menu charitable_services">
                        <a href="#charitable_services" data-active="true" data-toggle="collapse" aria-expanded="true" class="dropdown-toggle first-link">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-feather"><path d="M20.24 12.24a6 6 0 0 0-8.49-8.49L5 10.5V19h8.5z"></path><line x1="16" y1="8" x2="2" y2="22"></line><line x1="17.5" y1="15" x2="9" y2="15"></line></svg>                                
                                <span>{{ __('messages.charitable_services') }}</span>
                            </div>
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right"><polyline points="9 18 15 12 9 6"></polyline></svg>
                            </div>
                        </a>
                        <ul class="collapse submenu list-unstyled show" id="charitable_services" data-parent="#accordionExample">
                            @if(Auth::user()->add_data)
                                <li class="active add">
                                    <a href="/admin-panel/charitable_services/add"> {{ __('messages.add') }} </a>
                                </li>
                            @endif
                            <li class="show" >
                                <a href="/admin-panel/charitable_services/show"> {{ __('messages.show') }} </a>
                            </li>
                        </ul>
                    </li>                  
                    @endif                    
                    ...
                    <li class="menu news">
                        <a href="#news" data-active="true" data-toggle="collapse" aria-expanded="true" class="dropdown-toggle first-link">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-layers"><polygon points="12 2 2 7 12 12 22 7 12 2"></polygon><polyline points="2 17 12 22 22 17"></polyline><polyline points="2 12 12 17 22 12"></polyline></svg>
                        ...
                        <ul class="collapse submenu list-unstyled show" id="news" data-parent="#accordionExample">
                            @if(Auth::user()->add_data)
                                <li class="active add">
                                    <a href="/admin-panel/news/add"> {{ __('messages.add') }} </a>
                                </li>
                            @endif
                            <li class="show" >
                                <a href="/admin-panel/news/show"> {{ __('messages.show') }} </a>
                            </li>
                        </ul>
                    </li>                  
                    @endif                    
                    ...
                    <li class="menu counts">
                        <a href="/admin-panel/counts" class="dropdown-toggle first-link">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-hash"><line x1="4" y1="9" x2="20" y2="9"></line><line x1="4" y1="15" x2="20" y2="15"></line><line x1="10" y1="3" x2="8" y2="21"></line><line x1="16" y1="3" x2="14" y2="21"></line></svg>
                                <span>{{ __('messages.counts') }}</span>
                            </div>
                        </a>
                    </li>                   
                    @endif                    
                    ...
                    <li class="menu banks">
                        <a href="#banks" data-active="true" data-toggle="collapse" aria-expanded="true" class="dropdown-toggle first-link">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg>
                                <span>{{ __('messages.banks') }}</span>
                            </div>
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right"><polyline points="9 18 15 12 9 6"></polyline></svg>
                            </div>
                        </a>
                        <ul class="collapse submenu list-unstyled show" id="banks" data-parent="#accordionExample">
                            @if(Auth::user()->add_data)
                                <li class="active add">
                                    <a href="/admin-panel/banks/add"> {{ __('messages.add') }} </a>
                                </li>
                            @endif
                            <li class="show" >
                                <a href="/admin-panel/banks/show"> {{ __('messages.show') }} </a>
                            </li>
                        </ul>
                    </li>                  
                    @endif                       
                    ...
                    <li class="menu accounts_numbers">
                        <a href="#accounts_numbers" data-active="true" data-toggle="collapse" aria-expanded="true" class="dropdown-toggle first-link">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-credit-card"><rect x="1" y="4" width="22" height="16" rx="2" ry="2"></rect><line x1="1" y1="10" x2="23" y2="10"></line></svg>
                                <span>{{ __('messages.accounts_numbers') }}</span>
                            </div>
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right"><polyline points="9 18 15 12 9 6"></polyline></svg>
                            </div>
                        </a>
                        <ul class="collapse submenu list-unstyled show" id="accounts_numbers" data-parent="#accordionExample">
                            @if(Auth::user()->add_data)
                                <li class="active add">
                                    <a href="/admin-panel/accounts_numbers/add"> {{ __('messages.add') }} </a>
                                </li>
                            @endif
                            <li class="show" >
                                <a href="/admin-panel/accounts_numbers/show"> {{ __('messages.show') }} </a>
                            </li>
                        </ul>
                    </li>                  
                    @endif                     
                    ...
                    <li class="menu app_pages">
                        ...
                        <ul class="collapse submenu list-unstyled" id="app_pages" data-parent="#accordionExample">
                            <li class="aboutapp" >
                                <a href="/admin-panel/app_pages/aboutapp">{{ __('messages.aboutapp') }}</a>
                            </li>
                            <li class="association_establishment" >
                                <a href="/admin-panel/app_pages/association_establishment">{{ __('messages.association_establishment') }}</a>
                            </li>
                            <li class="thevission" >
                                <a href="/admin-panel/app_pages/thevission">{{ __('messages.thevission') }}</a>
                            </li>
                            <li class="themessage" >
                                <a href="/admin-panel/app_pages/themessage">{{ __('messages.themessage') }}</a>
                            </li>
                            <li class="organizational_structure" >
                                <a href="/admin-panel/app_pages/organizational_structure">{{ __('messages.organizational_structure') }}</a>
                            </li>
                            <li class="administration_board_members" >
                                <a href="/admin-panel/app_pages/administration_board_members">{{ __('messages.administration_board_members') }}</a>
                            </li>
                            <li class="termsandconditions" >
                                <a href="/admin-panel/app_pages/termsandconditions">{{ __('messages.termsandconditions') }}</a>
                            </li>                        
                        </ul>
                    </li>
                    @endif  
    ...
    <script src="/admin/plugins/bootstrap-maxlength/custom-bs-maxlength.js"></script>
    ...
    <!-- BEGIN PAGE LEVEL PLUGINS/CUSTOM SCRIPTS -->
        ...
        <script>
            ...
            var news_editor = new SimpleMDE({element: document.getElementById("news_editor")});
            var service_editor = new SimpleMDE({element : document.getElementById("service_editor")});
        </script>
